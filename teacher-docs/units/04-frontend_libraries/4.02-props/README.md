...
- [ ] Complete and submit Block 4.02: Competency Check.
...
- props
- controlled = does not have own state, everything controlled through props from parent
- uncontrolled = does manage own state
- import, export
